...
public class PartitionsTest {
  ...
  public void simplePartition() {
    ...
    Generator<Integer> partitionGenerator = createPartitionGenerator(5);
    Iterator<ICombinatoricsVector<Integer>> partitionIterator = partitionGenerator.iterator();
  ...
  public void simpleTwoPartition() {
    ...
    Generator<Integer> partitionGenerator = createPartitionGenerator(2);
    Iterator<ICombinatoricsVector<Integer>> partitionIterator = partitionGenerator.iterator();
  ...
  public void simpleOnePartition() {
    ...
    Generator<Integer> partitionGenerator = createPartitionGenerator(1);
    Iterator<ICombinatoricsVector<Integer>> partitionIterator = partitionGenerator.iterator();
  ...
  public void simpleEmptyPartition() {
    ...
    Generator<Integer> partitionGenerator = createPartitionGenerator(0);
    Iterator<ICombinatoricsVector<Integer>> partitionIterator = partitionGenerator.iterator();
  ...
  public void mostThreeIntegersPartition() {
    ...
    Generator<Integer> partitionGenerator = createPartitionGenerator(8);
