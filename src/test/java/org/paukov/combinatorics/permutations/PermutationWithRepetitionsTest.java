...
public class PermutationWithRepetitionsTest {
  ...
  public void simpleTreeTwoPermutationWithRepetition() {
    ...
    Generator<Integer> permutationWithRepetitionGenerator = createPermutationWithRepetitionGenerator(
        coreVector, 2);
  ...
  public void sizeofThreePermutations() {
    ...
    Generator<String> generator = createPermutationWithRepetitionGenerator(
        originalVector, 3);
  ...
  public void threeTuplesOfTwoElements() {
    ...
    Generator<Integer> generator = createPermutationWithRepetitionGenerator(
        originalVector, 3);
