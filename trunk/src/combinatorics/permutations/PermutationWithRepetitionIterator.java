 ...
 * 
 * @param <T> Type of elements in the permutation
 */
public class PermutationWithRepetitionIterator<T extends Object> implements Iterator<CombinatoricsVector<T>> {
   ...
   */
  public PermutationWithRepetitionIterator(PermutationWithRepetitionGenerator<T> generator) {
   ...
   * 
   * @see combinatorics.Iterator#first()
   */
  @Override
  public void first() {
    for (int j = 0; j <= _k; j++) {
   ...
   * 
   * @see combinatorics.Iterator#getCurrentItem()
   */
  @Override
   ...
   * 
   * @see combinatorics.Iterator#isDone()
   */
  @Override
   ...
   * 
   * @see combinatorics.Iterator#next()
   */
  @Override
  public void next() {
    _currentIndex++;
    ...
    for (int j = _k - 1; j >= 0; j--) {
      ...
      _currentPermutation.setValue(j, _generator.getCoreObject().getValue(index));
    }
